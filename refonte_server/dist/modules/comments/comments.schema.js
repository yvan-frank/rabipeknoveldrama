...
exports.chapterCommentIdParamSchema = exports.createChapterCommentSchema = exports.chapterIdParamSchema = exports.replyToReviewSchema = exports.upsertReviewSchema = exports.bookIdParamSchema = void 0;
...
exports.chapterCommentIdParamSchema = zod_1.z.object({
    commentId: zod_1.z.coerce.number().int().positive(),
});
